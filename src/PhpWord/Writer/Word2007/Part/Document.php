...
class Document extends AbstractPart
{
    ...
    public function write()
    {
        ...
        $xmlWriter->writeAttribute('xmlns:oel', 'http://schemas.microsoft.com/office/2019/extlst');
        ...
        $xmlWriter->writeAttribute('xmlns:w16sdtdh', 'http://schemas.microsoft.com/office/word/2020/wordml/sdtdatahash');
        ...
        $xmlWriter->writeAttribute('mc:Ignorable', 'w14 w15 w16se w16cid w16 w16cex w16sdtdh wp14');
